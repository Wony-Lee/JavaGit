...
<p></p>
<form id="revF" name="revF" action="ReviewWriteEnd.do" method="post"
			...
			<div class="row">
				...
				<div class="col-md-2">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link" href="appList.do">봉사신청</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="ReviewList.do">분양후기</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="BoardList.do">자유게시판</a>
						</li>
					</ul>
				</div>
				<!-- nav end -->
				<div class="col-md-10">
					<table class="table talbe-hover">
						...
						<tr>
							...
							<td><input type="text" class="form-control" placeholder="Center Name" id="center" name="center"></td>
						...
						<tr>
							<td colspan="2"><input type="file" id="imgInp1" name="image1"></td>
							<td colspan="2"><input class="justify-content-center" type="text" value="만든사람" readonly></td>
						...
						<tr class="col-md-4 offset-md-2">
							<td colspan="2">
 							...
 							<td colspan="2">
								<div class="justify-content-center"
									style="border: 1px solid gold;">
									<img src="images/ㅁㄴㅇ.png" class="rounded"
									 style="width: 100%">
								</div> 
							</td> 
						...
						<tr>
							...
							<td class="text-left" colspan="2">
								<button class="btn btn-outline-danger"
									onclick="location.href='ReviewList.do'">취소</button>
							</td>
						</tr>
					</table>
					<input type="text" class="form-control" id="midx" name="midx" value="9" readonly>
					<input type="text" class="form-control" id="downcg_code" name="downcg_code" value="6000" readonly>
				</div>
			</div>
		</div>
	</div>
