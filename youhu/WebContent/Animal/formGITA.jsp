...
<div class="text-left p-5">
	<h3 class="text-warning">${form3} 기타인데 폰트깨져서 안나옴</h3>
	<div class="row mt-4">
		...
		<%-- varStatus속성을 이용하면 반복문의 상태정보를 활용할 수 있다.
		 ...
		 --%>
			<div class="col-md-4">
				<%-- ${st.index} / ${st.count} --%>
				<a href="animDetail.do?iidx=${gita.iidx}"><img src="images/${gita.image}" class="rounded img-fluid"
				...
				<span class="text-danger">발견장소 : ${gita.addr}</span><br>
