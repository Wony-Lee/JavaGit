...
<div class="col-md-12">
	<div class="row">
		...
		<div class="col-md-9 text-left mt-1">
			<h1 class="text-center">동물정보 수정[: : : :]</h1>
			
			<form name="addAnim" id="addAnim" action="animUpdate.do" method="POST"
					...
					<tbody>
						...
						<tr>
							...
							<td width="30%"><input type="text" name="name"
								id="name" placeholder="작성자는 바꿀 수 없어요." disabled></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="30%"><input type="text" name="form"
								id="form" placeholder="종류는 바꿀 수 없어요." disabled></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="1" class="text-center">
								<button class="btn btn-success" onclick="accept()">바꾸기</button>
							</td>
						</tr>
					</tbody>
				</table>
