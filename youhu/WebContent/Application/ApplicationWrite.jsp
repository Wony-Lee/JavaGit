	...
	<div class="col-md-12">
		<div class="row">
			...
			<table class="table" style="border:2px solid darkgray">
				...
				<tr>
					<td class="text-right" colspan="2"><button type="submit" class="btn btn-success" id="btnWrite">신청</button></td>
					<td class="text-left" colspan="2">
					<button type="button" class="btn btn-danger" onclick="location.href='appList.do'">취소</button>
					</td>
				</tr>
			</table>
